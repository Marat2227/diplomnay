    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Укажите_Дату', models.DateTimeField(blank=True, null=True)),
                ('Статус', models.CharField(choices=[('todo', 'To Do'), ('in_progress', 'In Progress'), ('done', 'Done')], default='todo', max_length=20)),
